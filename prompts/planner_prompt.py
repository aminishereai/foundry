...
8. Keep each step's tool_args minimal: only the arguments actually needed, in the shape that tool expects (e.g. read_file expects a "path" string; search_files expects a "pattern" string).
